...
- 2026-06-02: 修复 `nature_all_in_one.py` 的 Source data section 扫描、`auto` 非流式控制流、并发 postfetch 不可达文章处理；已用真实 Nature 页面验证图像、caption、Source data 和 postfetch 链路。 (commit: unavailable; integrated workspace has no .git)
