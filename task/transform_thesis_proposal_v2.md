...
|---|---|---|
| 模糊 silent 率 | 77% [75-79] | **1079/1393 = 77% [95% CI 75-80]** |
| 澄清后 silent 率 | 10% | 312/1520 = 21% [19-23] |
| oracle recall | 98% | **1385/1391 = 100% [99-100]** |
| oracle FP | 0%(4/1855) | **2/1522 = 0% [0-0]** |

> **77% 的警钟数字在跨 229 篇独立 Nature 论文的全新语料上精确复现**(原 71 篇 → 229 篇,**3× 文章多样性**),CI 同样紧;recall 100%/FP 0% 检测近乎完美。诚实记账:本次 LLM 经代理调用,9%(287/3200)评估因代理过载 crash(已隔离,silent 率只在 exec-ok 任务上计;crash≠测量信号)——修复经过见 `nature_real_auto._llm_code_retry`。这次独立复制把"77% silent / oracle 近完美"从单一切片升级为**跨语料可复制**的结论。
